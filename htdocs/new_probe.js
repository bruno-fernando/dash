...
function ended(){
    ...
    //$.post('http://127.0.0.1:8000/insert',{hello:'helloooooo', blabla:'blablablabla'},_success);
    /*$.post({
...
$(document).ready(function(){
	...
	metrics={name:"video_GPAC",duration:0,startupTime:0,nbStalls:0};
	metrics.qualitySet=[];
	...
	var url = protocol+"://127.0.0.1:"+port+"/movies/gpac-content/mp4-main-multi-mpd-AV-NBS.mpd";
